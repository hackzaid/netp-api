...
Revision ID: e2aa6dd02254
Revises: 4ff3d13560d2
Create Date: 2023-01-08 21:51:01.482951
...
revision = 'e2aa6dd02254'
down_revision = '4ff3d13560d2'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('exportNo', sa.String(), nullable=True),
